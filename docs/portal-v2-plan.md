...
- Următorul pas tehnic: formularele staff în interfața de previzualizare, apoi bootstrap conturi, asocierea conturilor cu clienții, schimbarea parolei inițiale și teste reale în browser/Worker pe D1. După configurarea D1 UE și Worker: export criptat + probă de restaurare într-o bază separată, test Safari/mobil, comutarea controlată a căii exacte `/cleaning-services/portal/`.
